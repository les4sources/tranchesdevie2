  ...
  module Settings
    class ArtisansController < Admin::BaseController
      ...
      def create
        ...
        if @artisan.save
          redirect_to admin_settings_artisans_path, notice: "Artisan créé avec succès"
        else
      ...
      def update
        if @artisan.update(artisan_params)
          redirect_to admin_settings_artisans_path, notice: "Artisan mis à jour avec succès"
        else
